...
<table>
    ...
    <tr>
        <td>Menu Title:</td>
        <td><input class="required" name="menu_title" id="menu_title" size="100" type="text" value="<?php echo isset($data['menu_title']) ? $data['menu_title'] : ''; ?>" /></td>
    </tr>
    <tr>
        <td>URL:</td>
        <td><input class="required" name="url" id="url" size="100" type="text" value="<?php echo isset($data['url']) ? $data['url'] : ''; ?>" /></td>
    </tr>
    <tr>
        <td>Page Title:</td>
        <td><input name="page_title" id="page_title" size="100" type="text" value="<?php echo isset($data['page_title']) ? $data['page_title'] : ''; ?>" /></td>
    </tr>
    <tr>
        <td>H1 Title:</td>
        <td><input name="h1_title" id="h1_title" size="100" type="text" value="<?php echo isset($data['h1_title']) ? $data['h1_title'] : ''; ?>" /></td>
    </tr>
    <tr>
            <td>Header Image:</td>
    ...
    <tr>
        ...
        <td>
            <label><input type="checkbox" name="top_nav" value="1" <?php echo (isset($data['footer_nav']) && $data['top_nav'] == 1) ? 'checked="checked"' : ''; ?> />&nbsp;Main Navigation</label>
            <label><input type="checkbox" name="footer_nav" value="1" <?php echo (isset($data['footer_nav']) && $data['footer_nav'] == 1) ? 'checked="checked"' : ''; ?> />&nbsp;Footer Navigation</label>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            ?>
            <label style="display:block;padding:3px 0px;"><input type="checkbox" name="blocks[]" value="<?php echo $block['id']; ?>" <?php echo (isset($data['blocks']) && in_array($block['id'], $data['blocks'])) ? 'checked="checked"' : ''; ?> />&nbsp;<?php echo $block['title'] ?></label>
            <?php endforeach; ?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><textarea cols="50" rows="3" name="meta_keywords" id="meta_keywords"><?php echo isset($data['meta_keywords']) ? $data['meta_keywords'] : ''; ?></textarea></td>
    </tr>
    <tr>
            <td valign="top">Meta Description:</td>
        <td><textarea cols="50" rows="3" name="meta_description" id="meta_description"><?php echo isset($data['meta_description']) ? $data['meta_description'] : ''; ?></textarea></td>
    </tr>
    <tr>
