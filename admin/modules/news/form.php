...
<table>
    ...
    <tr>
        <td>Page Title:</td>
        <td><input name="page_title" id="page_title" size="50" type="text" value="<?php echo isset($data['page_title']) ? $data['page_title'] : ''; ?>" /></td>
    </tr>
    <tr>
        <td>Date:</td>
        <td><input name="news_date" id="news_date" size="50" type="text" class="datepicker" value="<?php echo isset($data['news_date']) ? $data['news_date'] : ''; ?>" /></td>
    </tr>
    <tr>
        <td>Content:</td>
